...
HD_PWD='C:/vivado-proj/spice16/spice16.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sp16_bus_selector.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sp16_bus_selector.tcl
